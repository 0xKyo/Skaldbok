...
// The pack the app writes the GM's own cards into ("Generate Kin", "Edit"...). It always loads LAST, so what it says can replace
// a card of any other pack, whatever the order of the folders.
constexpr const char* kCustomPack = "custom";
constexpr const char* kCustomPackName = "My Homebrew";     // what it calls itself: "Changed by My Homebrew" on an edited card
