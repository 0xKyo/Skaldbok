...
int main(int argc, char** argv) {
    ...
    SDL_SetAppMetadata("Skaldbok", nullptr, "com.skaldbok.app");
    ...
    // resource on Windows and assets/linux/icons on Linux — see the skaldbok target and install() rules in CMakeLists.txt).
    if (SDL_Surface* icon = gm::surfaceFromFile(paths.dataDir + "/packs/core/images/skaldbok-icon.png")) {
